...
const Resistencia_Imput_Tribu_A = document.getElementById('Resistencia_Input_Tribu_A')as HTMLInputElement;
...
const Resistencia_Imput_Tribu_B = document.getElementById('Resistencia_Input_Tribu_B')as HTMLInputElement;

const OutPutPuntajeA = document.getElementById('PuntajeA') as HTMLInputElement;
const OutPutPuntajeB = document.getElementById('PuntajeB') as HTMLInputElement;

const TribuGanadora = document.getElementById('EquipoGanador') as HTMLInputElement;

function sumar(): void {
    let Valor_A_Ingresado_Resistencia: number = parseInt(Resistencia_Imput_Tribu_A.value, 10) || 0;
    let Valor_A_Ingresado_Ajedrez: number = parseInt(Ajedrez_Input_Tribu_A.value, 10) || 0;
    let Valor_A_Ingresado_Handball: number = parseInt(Handball_Imput_Tribu_A.value, 10) || 0;

    let Valor_B_Ingresado_Resistencia: number = parseInt(Resistencia_Imput_Tribu_B.value, 10) || 0; 
    let Valor_B_Ingresado_Ajedrez: number = parseInt(Ajedrez_Input_Tribu_B.value, 10) || 0;
    let Valor_B_Ingresado_Handball: number = parseInt(Handball_Imput_Tribu_B.value, 10) || 0;
