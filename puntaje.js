...
var Handball_Input_Tribu_A = document.getElementById('Handball_Input_Tribu_A');
var Ajedrez_Input_Tribu_A = document.getElementById('Ajedrez_Input_Tribu_A');
var Resistencia_Input_Tribu_A = document.getElementById('Resistencia_Input_Tribu_A');
var Handball_Input_Tribu_B = document.getElementById('Handball_Input_Tribu_B');
var Ajedrez_Input_Tribu_B = document.getElementById('Ajedrez_Input_Tribu_B');
var Resistencia_Input_Tribu_B = document.getElementById('Resistencia_Input_Tribu_B');
...
function contar() {
    var Valor_A_Ingresado_Resistencia = parseInt(Resistencia_Input_Tribu_A.value, 10);
    var Valor_A_Ingresado_Ajedrez = parseInt(Ajedrez_Input_Tribu_A.value, 10);
    var Valor_A_Ingresado_Handball = parseInt(Handball_Input_Tribu_A.value, 10);
    var Valor_B_Ingresado_Resistencia = parseInt(Resistencia_Input_Tribu_B.value, 10);
    var Valor_B_Ingresado_Ajedrez = parseInt(Ajedrez_Input_Tribu_B.value, 10);
    var Valor_B_Ingresado_Handball = parseInt(Handball_Input_Tribu_B.value, 10);
